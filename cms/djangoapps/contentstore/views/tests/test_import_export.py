...
class TestCourseExportImportProblem(CourseTestCase):
    ...
    def get_problem_content(self, block_location):
        """
        Get problem content after exported course in imported back in
        """
    ...
    def assert_problem_definition(self, dest_course_location):
        """
    ...
    def test_problem_content_on_course_export_import(self, publish_item):
        ...
        """
        self._setup_source_course_with_problem_content(publish_item)
